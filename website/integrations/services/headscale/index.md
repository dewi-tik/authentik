...
- `headscale.company` is the FQDN of the Headscale installation. (Remove this for SaaS)
...
To support the integration of _Headscale_ with authentik, you need to create an application/provider pair in authentik.
...
Insert Headscale configuration
...
Template sentence that you can typically use here: "To confirm that authentik is properly configured with _Headscale_, log out and log back in via authentik."
